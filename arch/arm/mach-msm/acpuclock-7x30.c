...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 652800,  PLL_1, 2, 0, 153600000, 975, VDD_RAW(975) },
	{ 1, 768000,  PLL_1, 2, 0, 153600000, 975, VDD_RAW(975) },
	{ 1, 806400,  PLL_2, 3, 0, UINT_MAX, 1000, VDD_RAW(1000), &pll2_tbl[0]},
	{ 1, 921600,  PLL_2, 3, 0, UINT_MAX, 1050, VDD_RAW(1050), &pll2_tbl[1]},
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1075, VDD_RAW(1075), &pll2_tbl[2]},
	{ 1, 1113000, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1100), &pll2_tbl[3]},
	{ 1, 1209600, PLL_2, 3, 0, UINT_MAX, 1125, VDD_RAW(1125), &pll2_tbl[4]},
	...
	{ 0, 2016000, PLL_2, 3, 0, UINT_MAX, 1500, VDD_RAW(1500), &pll2_tbl[12]},
	{ 0 }
};
