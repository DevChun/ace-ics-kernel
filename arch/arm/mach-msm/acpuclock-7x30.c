...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	 ...
	 * AXI has MSMC1 implications. See above.
	 */
	{ 1, 806400,  PLL_2, 3, 0, 192000000, 1000, VDD_RAW(1000), &pll2_tbl[0]},
	{ 1, 1024000, PLL_2, 3, 0, 192000000, 1075, VDD_RAW(1075), &pll2_tbl[1]},
	{ 1, 1200000, PLL_2, 3, 0, 192000000, 1125, VDD_RAW(1125), &pll2_tbl[2]},
	{ 1, 1401600, PLL_2, 3, 0, 192000000, 1200, VDD_RAW(1200), &pll2_tbl[3]},
	{ 1, 1497600, PLL_2, 3, 0, 192000000, 1275, VDD_RAW(1275), &pll2_tbl[4]},
	{ 1, 1708800, PLL_2, 3, 0, 192000000, 1350, VDD_RAW(1350), &pll2_tbl[5]},
	{ 1, 1804800, PLL_2, 3, 0, 192000000, 1400, VDD_RAW(1400), &pll2_tbl[6]},
	{ 1, 1900800, PLL_2, 3, 0, 192000000, 1450, VDD_RAW(1450), &pll2_tbl[7]},
	{ 1, 2016000, PLL_2, 3, 0, 192000000, 1500, VDD_RAW(1500), &pll2_tbl[8]},
	{ 0 }
};
